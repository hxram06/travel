...
const TOKYO = (() => {
  ...
  const days = [
    ...
    { id: 'd3', date: '1.27', weekday: '수', title: '좋아하는 것들과, 노을', subtitle: '하라주쿠 · 시부야 · 시부야 스카이', steps: [
      ...
      journey('harajuku', '산리오 · 다마고치 · 오모테산도, 하라주쿠 쇼핑', 'omotesando', '오전~오후 · 2:00~2:30 마무리', ['harajuku-omotesando'], '산리오 하라주쿠·다케시타도리에서 시작해 다마고치 팩토리를 지나 오모테산도 사거리와 그 아래 상권까지 한 줄기로 둘러봐요. 지도에 쇼핑 거점이 함께 표시돼요. 2시~2시 반쯤 마무리하고 시부야로 넘어가요.', { photo: 'omotesando', highlights: ['산리오 하라주쿠 · 다케시타도리', '다마고치 팩토리 · 하라카도 3층 (현재 11:00~21:00)', '오모테산도 사거리 · 키디랜드 · 애플 오모테산도', '도큐플라자 · 오모테산도 힐스'], source: 'https://tamagotchi-factory.jp/', spots: [{ place: 'harajuku' }, { place: 'harakado' }, { name: '다케시타도리', query: '竹下通り' }, { name: '오모테산도 힐스', query: '表参道ヒルズ' }, { name: '애플 오모테산도', query: 'Apple 表参道' }, { name: 'niko and… 오모테산도', query: 'niko and TOKYO 表参道' }, { name: 'GYRE 오모테산도', query: 'GYRE 表参道' } ] }),
