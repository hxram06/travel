...
const TOKYO = (() => {
  ...
  const days = [
    { id: 'd1', date: '1.25', weekday: '월', title: '우에노에서 시작하는 첫날', subtitle: '공항에서 바로 우에노로. 짐을 맡기고 가볍게.', steps: [
      ...
      journey('ueno-walk', '우에노를 가볍게 둘러보기', 'ameyoko', '저녁 · 자유롭게', ['ueno-ameyoko'], '아메요코와 야마시로야 등 캐릭터 매장을 둘러봐요. 매장별 마감이 다르니 굿즈 쇼핑부터.', { photo: 'ueno', highlights: ['아메요코 거리', '야마시로야 캐릭터 굿즈', '드럭스토어·간식'], without: 'asakusa' }),
      ...
      journey('checkin', '편의점 들러 호텔로', 'hotel', '22:00 전후 휴식 목표', homeIn, '편의점에서 먹고 싶은 것을 고른 뒤 체크인. 오늘 산 것들을 펼쳐보며 첫날을 마무리해요.', { facts: ['호텔 빌라 퐁텐 그랜드 도쿄 타마치', '시바우라구치에서 도보 약 6분', '역과 호텔은 지하로 직접 연결되지 않아요'] }),
    ] },
    { id: 'd2', date: '1.26', weekday: '화', title: '하루 온전히, 디즈니랜드', subtitle: '가는 길과 돌아오는 길만 챙겨요.', steps: [
      ...
      journey('disney-back', '즐거운 하루 끝, 호텔로', 'hotel', '밤 · 원하는 시간에', ['disney-maihama', 'maihama-tokyo', 'tokyo-transfer-back', 'tokyo-tamachi', ...homeIn], '마이하마에서 도쿄행 열차 → 도쿄역에서 야마노테선 시나가와 방면 → 다마치. 출발 전에 막차를 확인해요.'),
    ] },
    { id: 'd3', date: '1.27', weekday: '수', title: '좋아하는 것들과, 노을', subtitle: '시부야 · 하라주쿠 · 시부야 스카이', steps: [
      journey('morning-out', '호텔에서 다마치역 근처로', 'tamachiEast', '아침', ['hotel-tamachi'], '호텔 조식을 먹었다면 바로 역으로. 밖에서 먹는다면 역 근처 아침 후보 중 골라요.'),
    ...
    { id: 'd4', date: '1.28', weekday: '목', title: '마지막 쇼핑, 도쿄의 밤', subtitle: '신주쿠 · 긴자 · 마루노우치', steps: [
      ...
      step('shinjuku', 'visit', '신주쿠에서 원하는 것 찾기', 'shinjukuShop', '오전 · 자유롭게', '캐릭터 굿즈, 옷, 화장품. 필요한 매장부터 골라 둘러보고 점심을 먹어요.', { photo: 'shinjuku', highlights: ['산리오·캐릭터 굿즈', '백화점·뷰티', '필요한 매장 중심으로'] }),
      ...
      journey('ginza', '긴자에서 마지막 쇼핑', 'ginzaShop', '오후 · 자유롭게', ['sanrio-ginza'], '산리오 NISHIGINZA부터 백화점·뷰티·선물까지. 매장 마감 전에 구매를 정리해요.', { photo: 'ginza', highlights: ['산리오 NISHIGINZA · 2층', '백화점·드럭스토어', '선물과 면세 쇼핑'] }),
      ...
      journey('tokyo-home', '도쿄역 → 다마치 → 호텔', 'hotel', '귀가', ['marunouchi-jr', 'tokyo-tamachi', ...homeIn], '야마노테선 외선 시나가와 방면. 호텔에서 짐을 정리하고 다음 날 공항 출발을 준비해요.'),
    ] },
