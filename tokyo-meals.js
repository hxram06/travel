...
const TOKYO_MEALS = (() => {
  ...
  const ueno=[
    ...
    r('마츠야 우에노점','松屋 上野店','우에노','규동·정식','약 ¥500–900','https://www.matsuyafoods.co.jp/','가정식'),
    r('코코이치방야 우에노점','CoCo壱番屋 上野','우에노','카레','약 ¥900–1,600','https://www.ichibanya.co.jp/','기타'),
    r('사이제리야 우에노점','サイゼリヤ 上野','우에노','파스타·이탈리안','약 ¥700–1,500','https://www.saizeriya.co.jp/','양식'),
  ];
  const tamachi=[
  ...
  const shibuya=[
    ...
    r('아후리 시부야점','AFURI 渋谷','시부야','유즈시오 라멘','약 ¥1,200–2,000','https://afuri.com/','일식'),
    r('시부야 요코초 미야시타파크','渋谷横丁 MIYASHITA PARK','미야시타파크','일본 각지 향토요리','약 ¥1,500–3,000','https://shibuya-yokocho.com/','기타',{note:'전국 향토요리 포장마차형. 늦게까지 영업.'}),
    r('코코이치방야 시부야점','CoCo壱番屋 渋谷','시부야','카레','약 ¥900–1,600','https://www.ichibanya.co.jp/','기타'),
  ];
  const shinjuku=[
    ...
    r('후운지 신주쿠 본점','風雲児 新宿','신주쿠 남쪽','츠케멘·라멘','약 ¥1,000–1,600',null,'일식',{note:'인기 츠케멘. 대기가 길 수 있어요.'}),
    r('마츠야 신주쿠 동쪽점','松屋 新宿東口店','신주쿠 동쪽','규동·정식','약 ¥500–900','https://www.matsuyafoods.co.jp/','가정식'),
    r('사이제리야 신주쿠점','サイゼリヤ 新宿','신주쿠','파스타·이탈리안','약 ¥700–1,500','https://www.saizeriya.co.jp/','양식'),
  ];
  const ginza=[
    ...
    r('텐야 긴자점','天丼てんや 銀座','긴자','텐동','약 ¥600–1,200','https://www.tenya.co.jp/','일식'),
    r('우오가시니혼이치 긴자점','魚がし日本一 銀座','긴자','입식 초밥·회','약 ¥1,500–3,000','https://www.uogashinihonichi.com/','회',{note:'서서 먹는 초밥. 빠르게 회·초밥.'}),
    r('오토야 긴자 미유키도리점','大戸屋 銀座みゆき通り店','긴자','가정식 정식','약 ¥1,000–1,800','https://www.ootoya.com/','가정식'),
  ];
  ...
  const asakusa=[
    ...
    r('마루가메제면 아사쿠사점','丸亀製麺 浅草','아사쿠사','우동·튀김','약 ¥500–1,200','https://www.marugame-seimen.com/','일식'),
    r('아사쿠사 스시로','スシロー 浅草','아사쿠사','회전초밥','약 ¥1,200–2,500','https://www.akindo-sushiro.co.jp/','회',{note:'가성비 회전초밥. 매장 위치·대기 확인.'}),
  ];
  // 3일차 하라주쿠·오모테산도 점심.
  const harajuku=[
    ...
    r('카페 카일라 오모테산도','Cafe Kaila 表参道','오모테산도','하와이안 팬케이크','약 ¥1,800–2,800','https://cafe-kaila.jp/','양식',{note:'인기 브런치, 피크 대기.'}),
    r('코코이치방야 진구마에점','CoCo壱番屋 神宮前','진구마에','카레','약 ¥900–1,600','https://www.ichibanya.co.jp/','기타'),
    r('사이제리야 진구마에점','サイゼリヤ 神宮前','진구마에','파스타·이탈리안','약 ¥700–1,500','https://www.saizeriya.co.jp/','양식'),
  ];
